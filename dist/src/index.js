...
function rotateObjectZ(obj, af, totalIterations) {
...
function rotateObjectX(obj, af, totalIterations) {
    // Calcular el centro del objeto
    var center = calculateCenter(obj);
    // Inicializar la matriz de rotación utilizando el centro como punto de origen
...
function calculateCenter(obj) {
    ...
    var numVertices = 376; // Número total de vértices del objeto
...
document.getElementById('pza12Izq').addEventListener('click', function () {
